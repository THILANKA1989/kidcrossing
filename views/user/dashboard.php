                    ...
                    <div class="card-grey">
                        ...
                        <?php
                            ...
                            foreach($events as $event){ ?>
                                 <?php if(!Yii::$app->findShared->isShared($event->shared_with,$event->user_id)){
                                     continue;
                                 } ?>
                         <?php
                      ...
                      <div class="card-grey">
                        ...
                        <?php
                            ...
                            foreach($journals as $journal){ ?>
                                 <?php if(Yii::$app->findShared->isShared($journal->shared_with,$journal->user_id) == false){
                                     continue;
                                 } ?>
                ...
                <div class="col-md-6">
                    <div class="col-md-12 semiwidget-white bordered-grey top-fixed-margin">
                      ...
                      <div class="panel-scroller-box">
                            ...
                            $i = 0;
                            $count = 1; 
                            foreach(array_reverse($wishlists) as $model){ 
